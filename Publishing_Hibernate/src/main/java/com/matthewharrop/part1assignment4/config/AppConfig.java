package com.matthewharrop.part1assignment4.config;
...
@ComponentScan(basePackages = "com.matthewharrop.part1assignment4")
...
public class AppConfig {
    ...
    public DataSource dataSource() {
        try {
            ...
            logger.error("Error creating DBCP DataSource!", e);
            return null;
        }
    }
    ...
    @Bean public SessionFactory sessionFactory() throws IOException {
        ...
        sessionFactoryBean.setPackagesToScan("com.matthewharrop.part1assignment4.domain");
